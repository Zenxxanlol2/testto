...
do
    local FunctionList = {math.abs, os.clock, coroutine.isyieldable, debug.info, Request, table.insert, bit32.bxor, debug.getfenv, setrawmetatable, pcall, math.random, setmetatable, string.split, debug.traceback, getrawmetatable, type, Select, table.concat, string.byte, string.char, debug.getinfo, islclosure, string.reverse, getmetatable}
